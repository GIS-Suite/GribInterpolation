...
public class DatasetLinearInterpolationTests {
    ...
    public void datasetLinearInterpolation_Should_Return_DataPointArrayList(){
       ...
       //DataPoint pointD11 = new DataPoint(103, -90, 39, 11);
        ...
        dataPointArrayList.add(pointA0);dataPointArrayList.add(pointB2);dataPointArrayList.add(pointC10);
        //dataPointArrayList.add(pointD11);
        dataPointArrayList.add(pointA3);dataPointArrayList.add(pointB1);dataPointArrayList.add(pointC4);
        //dataPointArrayList.add(pointD3);
        dataPointArrayList.add(pointA7);dataPointArrayList.add(pointB9);dataPointArrayList.add(pointC1);
        //dataPointArrayList.add(pointD6);
